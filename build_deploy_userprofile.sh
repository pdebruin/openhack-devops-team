...
installPath="apis/userprofile/charts/mydrive-user"
...
helm upgrade api-user $installPath --set repository.image=$TAG,env.webServerBaseUri=$BASE_URI,ingress.rules.endpoint.host=$dnsUrl